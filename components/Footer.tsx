...
import { ShieldCheck, Heart, ArrowUp, Mail, Globe } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-stone-800">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-stone-400 leading-relaxed max-w-md font-light">
              KAMA est la bibliothèque vivante de l’histoire noire et des cultures diasporiques. Un carrefour où les millénaires de savoirs, de révolutions et de créations se rencontrent dans un graphe de connaissances rigoureusement sourcé.
            </p>

            <div className="pt-2 flex items-center gap-3 text-xs text-stone-400">
              <ShieldCheck className="w-4 h-4 text-[#F2B844]" />
              <span>Corpus validé selon les critères méthodologiques de l’UNESCO</span>
            </div>
          </div>
          ...
          <div className="md:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs text-stone-300">
              <li><a href="#decouvrir" className="hover:text-white transition-colors">À découvrir</a></li>
              <li><a href="#explorer" className="hover:text-white transition-colors">Piliers thématiques</a></li>
              <li><a href="#chronologie" className="hover:text-white transition-colors">Chronologie (-3000 à 2026)</a></li>
              <li><a href="#graphe" className="hover:text-white transition-colors">Knowledge Graph</a></li>
              <li><a href="#regarder" className="hover:text-white transition-colors">Médiathèque & Vidéos</a></li>
              <li><a href="#parcours" className="hover:text-white transition-colors">KAMA Paths</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-3 space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-widest text-[#F2B844]">
              La Lettre des Archives
            </h4>
            <p className="text-xs text-stone-400">
              Recevez chaque dimanche un document d’archive rare et son analyse critique.
            </p>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-stone-500 gap-4">
          <div className="flex items-center gap-4">
            <span>© {new Date().getFullYear()} KAMA Living Archive. Tous droits réservés.</span>
            <span>•</span>
            <span className="text-stone-400">Pour la transmission ininterrompue des mémoires.</span>
          </div>
